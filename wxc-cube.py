...
logging.debug('## Successful CSV Import',df)
######
cfg_template = open(cfg_template,"r")
cfg_cube_config = cfg_template.read()
cfg_template.close
logging.debug('## Configuration template Successfully imported')
#########
WxC_ExtensionsRange = WxC_ExtensionsRange.replace("X",".")
print(WxC_ExtensionsRange)
...
print("Please wait 3 minutes untill the trunk is registered")
time.sleep(180) # Sleep for 3 seconds
#####
